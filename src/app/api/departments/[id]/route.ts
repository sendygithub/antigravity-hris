...
export async function DELETE(
    ...
    try {
        // hapus departmen dari database berdasarkan id
        const departmen = await prisma.department.delete({
        ...
        return NextResponse.json(
            {
                message: "departmen deleted successfully",
                departmen, // data departmen yang dihapus
            },
...
export async function PUT(
    ...
    try {
        // update departmen di database berdasarkan id
        const departmen = await prisma.department.update({
        ...
        return NextResponse.json({
            ...
            departmen, // data departmen setelah diupdate
        });
    } catch (e: any) {
        // jika error P2025: record tidak ditemukan
        return NextResponse.json(
            { error: e.code === "P2025" ? "departmen not found" : "Something went wrong" },
